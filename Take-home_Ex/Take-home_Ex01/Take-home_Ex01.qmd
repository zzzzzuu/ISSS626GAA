...
networks have to be in LINESTRING version. not MULTILINE. MULTILINE STRING don't work. If we happen to have that, use SF to break into single line. Pay attention because in openstreetmap it will be multiline string. Will give error message in code.

Anything that detect driver behaviour and physical, create subset. Caused by drink? ruthless driving? Junction? it's in the acident dtapoint.
